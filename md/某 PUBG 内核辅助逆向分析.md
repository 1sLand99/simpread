> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.52pojie.cn](https://www.52pojie.cn/thread-2115015-1-1.html)

> [md]# 某 PUBG 内核辅助逆向分析最近一个朋友发了一个 PUBG 的内核挂过来，名字就不说了，避免麻烦。久仰外挂隐藏之大名，正好拿来看看现在的内核辅助是怎么写的，用了 ...
...
<table><thead><tr><th>段</th><th>范围</th><th>大小</th><th>说明</th></tr></thead><tbody><tr><td><code>.rodata</code></td><td>0x5c040 - 0x215278c</td><td><strong>34.5 MB</strong></td><td>只读数据</td></tr><tr><td><code>.text</code></td><td>0x21b69f0 - 0x26e0018</td><td>5.2 MB</td><td>代码</td></tr><tr><td><code>.bss</code></td><td>0x26f7240 - 0x272eaa0</td><td>225 KB</td><td>未初始化数据</td></tr></tbody></table>
...
<table><thead><tr><th>全局变量</th><th>内核版本</th></tr></thead><tbody><tr><td><code>xmmword_26F7E00</code></td><td>4.14.117</td></tr><tr><td><code>xmmword_26F7E20</code></td><td>4.14.141</td></tr><tr><td><code>xmmword_26F7E40</code></td><td>4.14.180</td></tr><tr><td><code>xmmword_26F7E60</code></td><td>4.14.186</td></tr><tr><td><code>xmmword_26F7E80</code></td><td>4.19.81</td></tr><tr><td><code>xmmword_26F7EA0</code></td><td>4.19.113</td></tr><tr><td><code>xmmword_26F7F00</code></td><td>4.19.191</td></tr><tr><td><code>xmmword_26F7FA0</code></td><td>5.10</td></tr><tr><td><code>xmmword_26F7FC0</code></td><td>5.15</td></tr><tr><td><code>xmmword_26F7FE0</code></td><td>6.1</td></tr><tr><td><code>xmmword_26F8000</code></td><td>6.6</td></tr></tbody></table>
...
<table><thead><tr><th>Android 版本</th><th>createSurface 签名</th><th>变化</th></tr></thead><tbody><tr><td>5-7</td><td><code>(String8&amp;, uint, uint, int, uint)</code></td><td>基础 5 参数</td></tr><tr><td>8</td><td><code>(..., SurfaceControl*, uint, uint)</code></td><td>加父容器 + flags</td></tr><tr><td>9</td><td><code>(..., SurfaceControl*, int, int)</code></td><td>参数类型变了</td></tr><tr><td>10</td><td><code>(..., SurfaceControl*, LayerMetadata)</code></td><td>加 metadata</td></tr><tr><td>11</td><td><code>(..., SurfaceControl*, LayerMetadata, uint*)</code></td><td>加输出参数</td></tr><tr><td>12-13</td><td><code>(..., IBinder&amp;, LayerMetadata, uint*)</code></td><td>父容器改为 IBinder</td></tr><tr><td>14+</td><td><code>(..., int, int, IBinder&amp;, gui::LayerMetadata, uint*)</code></td><td>gui 命名空间</td></tr></tbody></table>
...
<table><thead><tr><th>层级</th><th>技术</th><th>目的</th></tr></thead><tbody><tr><td>文件层</td><td>5 秒自删 .sh + insmod 后删 .ko</td><td>磁盘无痕</td></tr><tr><td>内核层</td><td>list_del + kobject_del</td><td>lsmod/sysfs 不可见</td></tr><tr><td>内存层</td><td>物理地址直读，不走 ptrace/process_vm_readv</td><td>绕过 API 级监控</td></tr><tr><td>渲染层</td><td>setTrustedOverlay(true)</td><td>截图 / 录屏不可见</td></tr><tr><td>输入层</td><td>chmod 000 + uinput 虚拟设备</td><td>隐藏注入行为</td></tr><tr><td>命名层</td><td>随机 40 字符文件名 + stdout 重定向 /dev/null</td><td>进程 / 文件名无特征</td></tr></tbody></table>
...
附件我感觉不能传了，各位自己可以去搜搜，然后分析一下对抗

![](https://avatar.52pojie.cn/images/noavatar_middle.gif)msmvc 写挂的牛 X, 楼主能逆向分析出来更牛 X![](https://avatar.52pojie.cn/data/avatar/002/43/67/04_avatar_middle.jpg)rsds0duck

> [msmvc 发表于 2026-6-30 14:25](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=55469181&ptid=2115015)  
> 写挂的牛 X, 楼主能逆向分析出来更牛 X

这东西没加固，只是包装成 sh 脚本了，二进制直接可以提取出来![](https://static.52pojie.cn/static/image/smiley/default/4.gif) ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) msmvc

> [rsds0duck 发表于 2026-6-30 14:36](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=55469337&ptid=2115015)  
> 这东西没加固，只是包装成 sh 脚本了，二进制直接可以提取出来

这是用 linux 下的 shell 写了外挂?![](https://avatar.52pojie.cn/images/noavatar_middle.gif)xiaopacai007> [msmvc 发表于 2026-6-30 14:39](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=55469360&ptid=2115015)  
> 这是用 linux 下的 shell 写了外挂?

shell 只是打开外挂的钥匙，打开后就自己删除自己了 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif)ljkgpxs 看完整篇分析，不仅感概写挂的牛哇，对分析物资、计算敌人位置这部分，我还是挺好奇的，不知道是怎么实现的 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) yqduan 大佬太强了！![](https://avatar.52pojie.cn/images/noavatar_middle.gif)LiLittleCat 外挂作者都是逆向高手啊 ![](https://avatar.52pojie.cn/images/noavatar_middle.gif) cloudos 牛蛙牛蛙，分析的很到位，仅看看而已。小白路过